...
void vm_write(int n, int arg)
{
        switch(arg)
        {
                case 0:fprintf(stderr, "%d\n", n);break;
                case 1:fprintf(stderr, "%d\t", n);break;
                case 2:fprintf(stderr, "%d", n);break;
                case 3:fprintf(stderr, "%c\n", n);break;
                case 4:fprintf(stderr, "%c\t", n);break;
                case 5:fprintf(stderr, "%c", n);break;
        }
}
